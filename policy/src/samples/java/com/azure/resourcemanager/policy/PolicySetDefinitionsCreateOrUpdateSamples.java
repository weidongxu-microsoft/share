...
public final class PolicySetDefinitionsCreateOrUpdateSamples {
     ...
     *     customized policies and assign them at a scope.
     */
    public static void createOrUpdateAPolicySetDefinition(com.azure.resourcemanager.policy.PolicyManager policyManager)
        throws IOException {
        policyManager
            .policySetDefinitions()
            .define("CostManagement")
                ...
                mapOf(
                    ...
                    new ParameterDefinitionsValue()
                        ...
                        .withDefaultValue(
                            SerializerFactory
                                .createDefaultManagementSerializerAdapter()
                                .deserialize("\"myPrefix\"", Object.class, SerializerEncoding.JSON))
                        .withMetadata(
