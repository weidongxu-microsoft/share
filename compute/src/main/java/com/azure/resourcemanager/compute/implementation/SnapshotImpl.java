...
public final class SnapshotImpl implements Snapshot, Snapshot.Definition, Snapshot.Update {
    ...
    SnapshotImpl(String name, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
    ...
    SnapshotImpl(SnapshotInner innerObject, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
