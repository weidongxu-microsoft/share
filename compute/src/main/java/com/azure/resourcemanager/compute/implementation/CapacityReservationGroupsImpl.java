...
import com.azure.resourcemanager.compute.models.CapacityReservationGroup;
...
public final class CapacityReservationGroupsImpl implements CapacityReservationGroups {
    ...
    public CapacityReservationGroupsImpl(
        CapacityReservationGroupsClient innerClient, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
    ...
    public void deleteById(String id) {
        ...
        this.deleteWithResponse(resourceGroupName, capacityReservationGroupName, Context.NONE).getValue();
    }
