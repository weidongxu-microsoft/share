...
public final class ProximityPlacementGroupImpl
    ...
    ProximityPlacementGroupImpl(String name, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
    ...
    ProximityPlacementGroupImpl(
        ProximityPlacementGroupInner innerObject, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
