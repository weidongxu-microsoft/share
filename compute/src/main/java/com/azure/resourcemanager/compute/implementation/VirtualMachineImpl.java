...
import com.azure.resourcemanager.compute.models.VirtualMachineInstallPatchesResult;
...
public final class VirtualMachineImpl implements VirtualMachine, VirtualMachine.Definition, VirtualMachine.Update {
    ...
    VirtualMachineImpl(String name, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
    ...
    VirtualMachineImpl(
        VirtualMachineInner innerObject, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
