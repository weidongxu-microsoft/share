...
public final class AvailabilitySetImpl implements AvailabilitySet, AvailabilitySet.Definition, AvailabilitySet.Update {
    ...
    AvailabilitySetImpl(String name, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
    ...
    AvailabilitySetImpl(
        AvailabilitySetInner innerObject, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
