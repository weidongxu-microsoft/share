...
public final class DedicatedHostImpl implements DedicatedHost, DedicatedHost.Definition, DedicatedHost.Update {
    ...
    DedicatedHostImpl(String name, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
    ...
    DedicatedHostImpl(DedicatedHostInner innerObject, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
