...
public final class GalleryImageVersionImpl
    ...
    GalleryImageVersionImpl(String name, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
    ...
    GalleryImageVersionImpl(
        GalleryImageVersionInner innerObject, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
