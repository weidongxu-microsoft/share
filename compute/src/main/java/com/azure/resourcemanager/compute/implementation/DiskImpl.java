...
public final class DiskImpl implements Disk, Disk.Definition, Disk.Update {
    ...
    DiskImpl(String name, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
    ...
    DiskImpl(DiskInner innerObject, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
