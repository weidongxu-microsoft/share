...
public final class DedicatedHostGroupImpl
    ...
    DedicatedHostGroupImpl(String name, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
    ...
    DedicatedHostGroupImpl(
        DedicatedHostGroupInner innerObject, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
