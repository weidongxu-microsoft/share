...
public final class CloudServiceImpl implements CloudService, CloudService.Definition, CloudService.Update {
    ...
    CloudServiceImpl(String name, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
    ...
    CloudServiceImpl(CloudServiceInner innerObject, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
