...
public final class SshPublicKeyResourceImpl
    ...
    SshPublicKeyResourceImpl(String name, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
    ...
    SshPublicKeyResourceImpl(
        SshPublicKeyResourceInner innerObject, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
