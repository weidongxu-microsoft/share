...
public final class VirtualMachineRunCommandImpl
    ...
    VirtualMachineRunCommandImpl(String name, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
    ...
    VirtualMachineRunCommandImpl(
        VirtualMachineRunCommandInner innerObject, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
