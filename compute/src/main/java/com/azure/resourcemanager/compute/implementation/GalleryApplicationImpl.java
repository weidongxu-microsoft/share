...
public final class GalleryApplicationImpl
    ...
    GalleryApplicationImpl(String name, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
    ...
    GalleryApplicationImpl(
        GalleryApplicationInner innerObject, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
