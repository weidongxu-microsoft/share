...
public final class DiskAccessImpl implements DiskAccess, DiskAccess.Definition, DiskAccess.Update {
    ...
    DiskAccessImpl(String name, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
    ...
    DiskAccessImpl(DiskAccessInner innerObject, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
