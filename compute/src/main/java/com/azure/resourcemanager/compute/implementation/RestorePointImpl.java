...
public final class RestorePointImpl implements RestorePoint, RestorePoint.Definition {
    ...
    RestorePointImpl(RestorePointInner innerObject, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
    ...
    RestorePointImpl(String name, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
