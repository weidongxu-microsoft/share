...
public final class VirtualMachineExtensionImpl
    ...
    VirtualMachineExtensionImpl(String name, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
    ...
    VirtualMachineExtensionImpl(
        VirtualMachineExtensionInner innerObject, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
