...
public final class GalleryImpl implements Gallery, Gallery.Definition, Gallery.Update {
    ...
    GalleryImpl(String name, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
    ...
    GalleryImpl(GalleryInner innerObject, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
