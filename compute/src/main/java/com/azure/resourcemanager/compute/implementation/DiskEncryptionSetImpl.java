...
public final class DiskEncryptionSetImpl
    ...
    DiskEncryptionSetImpl(String name, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
    ...
    DiskEncryptionSetImpl(
        DiskEncryptionSetInner innerObject, com.azure.resourcemanager.compute.ComputeManager serviceManager) {
