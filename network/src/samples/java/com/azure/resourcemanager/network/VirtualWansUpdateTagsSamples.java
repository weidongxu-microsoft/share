...
public final class VirtualWansUpdateTagsSamples {
     ...
     */
    public static void virtualWANUpdate(com.azure.resourcemanager.network.NetworkManager networkManager) {
        VirtualWan resource =
            networkManager.virtualWans().getByResourceGroupWithResponse("rg1", "wan1", Context.NONE).getValue();
