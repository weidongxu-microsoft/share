...
public final class ConnectionMonitorsCreateOrUpdateSamples {
     ...
     */
    public static void createConnectionMonitorV1(com.azure.resourcemanager.network.NetworkManager networkManager) {
        networkManager
            .connectionMonitors()
            .define("cm1")
     ...
     * @param networkManager Entry point to NetworkManager. Network Client.
     */
    public static void createConnectionMonitorV2(com.azure.resourcemanager.network.NetworkManager networkManager) {
        networkManager
            .connectionMonitors()
            .define("cm1")
            .withExistingNetworkWatcher("rg1", "nw1")
