...
public final class AzureFirewallsUpdateTagsSamples {
     ...
     */
    public static void updateAzureFirewallTags(com.azure.resourcemanager.network.NetworkManager networkManager) {
        AzureFirewall resource =
            networkManager.azureFirewalls().getByResourceGroupWithResponse("azfwtest", "fw1", Context.NONE).getValue();
