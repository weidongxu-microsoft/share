...
public final class ExpressRouteCircuitsUpdateTagsSamples {
     ...
     */
    public static void updateExpressRouteCircuitTags(com.azure.resourcemanager.network.NetworkManager networkManager) {
        ExpressRouteCircuit resource =
            networkManager
                .expressRouteCircuits()
                .getByResourceGroupWithResponse("ertest", "er1", Context.NONE)
                .getValue();
