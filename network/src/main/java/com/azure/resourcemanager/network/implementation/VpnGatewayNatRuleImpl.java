...
public final class VpnGatewayNatRuleImpl
    ...
    VpnGatewayNatRuleImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    VpnGatewayNatRuleImpl(
        VpnGatewayNatRuleInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
