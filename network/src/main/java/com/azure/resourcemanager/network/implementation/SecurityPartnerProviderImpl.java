...
public final class SecurityPartnerProviderImpl
    ...
    SecurityPartnerProviderImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    SecurityPartnerProviderImpl(
        SecurityPartnerProviderInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
