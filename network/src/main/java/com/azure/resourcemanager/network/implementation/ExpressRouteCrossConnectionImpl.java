...
public final class ExpressRouteCrossConnectionImpl
    ...
    ExpressRouteCrossConnectionImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    ExpressRouteCrossConnectionImpl(
        ExpressRouteCrossConnectionInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
