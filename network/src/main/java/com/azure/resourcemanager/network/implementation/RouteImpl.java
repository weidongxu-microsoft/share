...
public final class RouteImpl implements Route, Route.Definition, Route.Update {
    ...
    RouteImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    RouteImpl(RouteInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
