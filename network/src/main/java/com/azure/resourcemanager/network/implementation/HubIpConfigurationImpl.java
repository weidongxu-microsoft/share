...
import com.azure.resourcemanager.network.models.HubIpConfiguration;
...
public final class HubIpConfigurationImpl
    ...
    HubIpConfigurationImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    HubIpConfigurationImpl(
        HubIpConfigurationInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
