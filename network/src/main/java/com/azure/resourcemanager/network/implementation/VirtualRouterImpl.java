...
import com.azure.resourcemanager.network.models.VirtualRouter;
...
public final class VirtualRouterImpl implements VirtualRouter, VirtualRouter.Definition, VirtualRouter.Update {
    ...
    VirtualRouterImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    VirtualRouterImpl(VirtualRouterInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
