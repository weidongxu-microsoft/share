...
public final class BgpConnectionImpl implements BgpConnection, BgpConnection.Definition, BgpConnection.Update {
    ...
    BgpConnectionImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    BgpConnectionImpl(BgpConnectionInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
