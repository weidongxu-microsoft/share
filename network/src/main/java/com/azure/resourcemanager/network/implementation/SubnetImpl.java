...
import com.azure.resourcemanager.network.models.ServiceEndpointPolicy;
...
public final class SubnetImpl implements Subnet, Subnet.Definition, Subnet.Update {
    ...
    SubnetImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    SubnetImpl(SubnetInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
