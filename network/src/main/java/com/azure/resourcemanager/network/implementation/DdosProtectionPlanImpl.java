...
public final class DdosProtectionPlanImpl
    ...
    DdosProtectionPlanImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    DdosProtectionPlanImpl(
        DdosProtectionPlanInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
