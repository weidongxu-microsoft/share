...
public final class VpnSiteImpl implements VpnSite, VpnSite.Definition, VpnSite.Update {
    ...
    VpnSiteImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    VpnSiteImpl(VpnSiteInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
