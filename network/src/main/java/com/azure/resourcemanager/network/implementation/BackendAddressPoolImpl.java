...
public final class BackendAddressPoolImpl
    ...
    BackendAddressPoolImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    BackendAddressPoolImpl(
        BackendAddressPoolInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
