...
import com.azure.resourcemanager.network.models.VirtualNetwork;
import com.azure.resourcemanager.network.models.VirtualNetworkBgpCommunities;
import com.azure.resourcemanager.network.models.VirtualNetworkPeering;
...
public final class VirtualNetworkImpl implements VirtualNetwork, VirtualNetwork.Definition, VirtualNetwork.Update {
    ...
    VirtualNetworkImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    VirtualNetworkImpl(
        VirtualNetworkInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
