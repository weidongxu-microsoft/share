...
public final class PrivateEndpointImpl implements PrivateEndpoint, PrivateEndpoint.Definition, PrivateEndpoint.Update {
    ...
    PrivateEndpointImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    PrivateEndpointImpl(
        PrivateEndpointInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
