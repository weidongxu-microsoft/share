...
public final class InboundNatRuleImpl implements InboundNatRule, InboundNatRule.Definition, InboundNatRule.Update {
    ...
    InboundNatRuleImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    InboundNatRuleImpl(
        InboundNatRuleInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
