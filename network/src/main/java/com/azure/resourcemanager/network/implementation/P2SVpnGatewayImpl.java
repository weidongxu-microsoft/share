...
public final class P2SVpnGatewayImpl implements P2SVpnGateway, P2SVpnGateway.Definition, P2SVpnGateway.Update {
    ...
    P2SVpnGatewayImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    P2SVpnGatewayImpl(P2SVpnGatewayInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
