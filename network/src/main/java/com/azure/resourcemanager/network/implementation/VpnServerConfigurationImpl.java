...
public final class VpnServerConfigurationImpl
    ...
    VpnServerConfigurationImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    VpnServerConfigurationImpl(
        VpnServerConfigurationInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
