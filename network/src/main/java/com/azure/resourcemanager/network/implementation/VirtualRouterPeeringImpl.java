...
import com.azure.resourcemanager.network.models.VirtualRouterPeering;
...
public final class VirtualRouterPeeringImpl
    ...
    VirtualRouterPeeringImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    VirtualRouterPeeringImpl(
        VirtualRouterPeeringInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
