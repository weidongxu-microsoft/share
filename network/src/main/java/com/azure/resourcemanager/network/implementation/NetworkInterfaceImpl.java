...
public final class NetworkInterfaceImpl
    ...
    NetworkInterfaceImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    NetworkInterfaceImpl(
        NetworkInterfaceInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
