...
public final class SecurityRuleImpl implements SecurityRule, SecurityRule.Definition, SecurityRule.Update {
    ...
    SecurityRuleImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    SecurityRuleImpl(SecurityRuleInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
