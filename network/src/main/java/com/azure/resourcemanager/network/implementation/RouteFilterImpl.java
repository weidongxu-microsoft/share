...
public final class RouteFilterImpl implements RouteFilter, RouteFilter.Definition, RouteFilter.Update {
    ...
    RouteFilterImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    RouteFilterImpl(RouteFilterInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
