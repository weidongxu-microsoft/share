...
public final class PublicIpPrefixImpl implements PublicIpPrefix, PublicIpPrefix.Definition, PublicIpPrefix.Update {
    ...
    PublicIpPrefixImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    PublicIpPrefixImpl(
        PublicIpPrefixInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
