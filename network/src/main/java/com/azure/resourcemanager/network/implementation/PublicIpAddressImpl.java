...
import com.azure.resourcemanager.network.models.NatGateway;
...
public final class PublicIpAddressImpl implements PublicIpAddress, PublicIpAddress.Definition, PublicIpAddress.Update {
    ...
    PublicIpAddressImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    PublicIpAddressImpl(
        PublicIpAddressInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
