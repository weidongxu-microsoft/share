...
public final class NetworkProfileImpl implements NetworkProfile, NetworkProfile.Definition, NetworkProfile.Update {
    ...
    NetworkProfileImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    NetworkProfileImpl(
        NetworkProfileInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
