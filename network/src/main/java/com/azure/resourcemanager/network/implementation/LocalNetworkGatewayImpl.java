...
public final class LocalNetworkGatewayImpl
    ...
    LocalNetworkGatewayImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    LocalNetworkGatewayImpl(
        LocalNetworkGatewayInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
