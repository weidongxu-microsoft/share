...
import com.azure.resourcemanager.network.models.DscpConfiguration;
...
public final class DscpConfigurationImpl
    ...
    DscpConfigurationImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    DscpConfigurationImpl(
        DscpConfigurationInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
