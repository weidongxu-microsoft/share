...
public final class RouteTableImpl implements RouteTable, RouteTable.Definition, RouteTable.Update {
    ...
    RouteTableImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    RouteTableImpl(RouteTableInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
