...
import com.azure.resourcemanager.network.models.ExpressRouteCircuitConnection;
...
public final class ExpressRouteCircuitPeeringImpl
    ...
    ExpressRouteCircuitPeeringImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    ExpressRouteCircuitPeeringImpl(
        ExpressRouteCircuitPeeringInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
