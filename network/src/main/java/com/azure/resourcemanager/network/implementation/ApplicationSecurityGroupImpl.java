...
public final class ApplicationSecurityGroupImpl
    ...
    ApplicationSecurityGroupImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    ApplicationSecurityGroupImpl(
        ApplicationSecurityGroupInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
