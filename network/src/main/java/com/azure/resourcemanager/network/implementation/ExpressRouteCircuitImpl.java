...
public final class ExpressRouteCircuitImpl
    ...
    ExpressRouteCircuitImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    ExpressRouteCircuitImpl(
        ExpressRouteCircuitInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
