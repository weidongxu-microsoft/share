...
import com.azure.resourcemanager.network.models.IpAllocation;
...
public final class IpAllocationImpl implements IpAllocation, IpAllocation.Definition, IpAllocation.Update {
    ...
    IpAllocationImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    IpAllocationImpl(IpAllocationInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
