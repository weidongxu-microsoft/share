...
public final class VirtualWanImpl implements VirtualWan, VirtualWan.Definition, VirtualWan.Update {
    ...
    VirtualWanImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    VirtualWanImpl(VirtualWanInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
