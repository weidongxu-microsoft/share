...
import com.azure.resourcemanager.network.models.CustomIpPrefix;
...
public final class CustomIpPrefixImpl implements CustomIpPrefix, CustomIpPrefix.Definition, CustomIpPrefix.Update {
    ...
    CustomIpPrefixImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    CustomIpPrefixImpl(
        CustomIpPrefixInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
