...
public final class HubRouteTableImpl implements HubRouteTable, HubRouteTable.Definition, HubRouteTable.Update {
    ...
    HubRouteTableImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    HubRouteTableImpl(HubRouteTableInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
