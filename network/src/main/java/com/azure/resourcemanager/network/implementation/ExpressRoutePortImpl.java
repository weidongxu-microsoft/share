...
import com.azure.resourcemanager.network.models.ExpressRoutePort;
...
public final class ExpressRoutePortImpl
    ...
    ExpressRoutePortImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    ExpressRoutePortImpl(
        ExpressRoutePortInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
