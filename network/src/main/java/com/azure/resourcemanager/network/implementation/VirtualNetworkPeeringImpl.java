...
public final class VirtualNetworkPeeringImpl
    ...
    VirtualNetworkPeeringImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    VirtualNetworkPeeringImpl(
        VirtualNetworkPeeringInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
