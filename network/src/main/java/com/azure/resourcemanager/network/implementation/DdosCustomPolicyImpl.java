...
public final class DdosCustomPolicyImpl
    ...
    DdosCustomPolicyImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    DdosCustomPolicyImpl(
        DdosCustomPolicyInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
