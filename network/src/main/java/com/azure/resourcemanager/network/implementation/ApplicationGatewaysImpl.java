...
import com.azure.resourcemanager.network.models.ApplicationGatewayAvailableSslOptions;
...
public final class ApplicationGatewaysImpl implements ApplicationGateways {
    ...
    public ApplicationGatewaysImpl(
        ApplicationGatewaysClient innerClient, com.azure.resourcemanager.network.NetworkManager serviceManager) {
