...
public final class ApplicationGatewayImpl
    ...
    ApplicationGatewayImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    ApplicationGatewayImpl(
        ApplicationGatewayInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
