...
public final class ServiceEndpointPolicyImpl
    ...
    ServiceEndpointPolicyImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    ServiceEndpointPolicyImpl(
        ServiceEndpointPolicyInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
