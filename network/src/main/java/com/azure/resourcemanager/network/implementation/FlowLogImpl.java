...
public final class FlowLogImpl implements FlowLog, FlowLog.Definition, FlowLog.Update {
    ...
    FlowLogImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    FlowLogImpl(FlowLogInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
