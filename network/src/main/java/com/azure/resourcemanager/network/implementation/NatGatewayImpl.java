...
public final class NatGatewayImpl implements NatGateway, NatGateway.Definition, NatGateway.Update {
    ...
    NatGatewayImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    NatGatewayImpl(NatGatewayInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
