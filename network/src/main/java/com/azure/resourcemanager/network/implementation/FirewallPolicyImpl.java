...
import com.azure.resourcemanager.network.models.FirewallPolicy;
...
public final class FirewallPolicyImpl implements FirewallPolicy, FirewallPolicy.Definition, FirewallPolicy.Update {
    ...
    FirewallPolicyImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    FirewallPolicyImpl(
        FirewallPolicyInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
