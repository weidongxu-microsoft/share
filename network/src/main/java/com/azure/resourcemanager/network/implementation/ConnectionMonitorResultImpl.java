...
public final class ConnectionMonitorResultImpl
    ...
    ConnectionMonitorResultImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    ConnectionMonitorResultImpl(
        ConnectionMonitorResultInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
