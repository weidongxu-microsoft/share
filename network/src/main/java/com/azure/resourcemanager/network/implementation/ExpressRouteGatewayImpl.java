...
public final class ExpressRouteGatewayImpl
    ...
    ExpressRouteGatewayImpl(String name, com.azure.resourcemanager.network.NetworkManager serviceManager) {
    ...
    ExpressRouteGatewayImpl(
        ExpressRouteGatewayInner innerObject, com.azure.resourcemanager.network.NetworkManager serviceManager) {
